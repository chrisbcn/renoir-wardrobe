// src/lib/component-focused-analyzer.js
// Component-focused analyzer inspired by renoir_demo's successful approach

import FashionpediaVocabulary from './fashionpedia-vocabulary.js';

class ComponentFocusedAnalyzer {
  constructor() {
...
`;
  ...
  async analyzeImage(imageData, analysisType = 'wardrobe') {
    try {
      console.log(`Starting component-focused analysis for type: ${analysisType}`);
      ...
      console.error('Component-focused analysis error:', error);
      return {
        success: false,
        error: error.message,
        confidence: 0,
...
export default new ComponentFocusedAnalyzer();
