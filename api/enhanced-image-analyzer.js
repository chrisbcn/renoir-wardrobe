// api/enhanced-image-analyzer.js
...
Provide detailed, specific observations rather than generic descriptions. Focus on elements that matter to luxury consumers and professional stylists.`;
  ...
  async analyzeWardrobeImage(imageFile, userId, existingAnalysis = null) {
    try {
      console.log(`Starting enhanced luxury analysis for wardrobe item`);

      // Convert File to base64
      const base64 = await this.fileToBase64(imageFile);
      
      // Step 1: Get detailed luxury analysis using your original prompt
      const luxuryAnalysis = await this.getLuxuryAnalysis(base64);
